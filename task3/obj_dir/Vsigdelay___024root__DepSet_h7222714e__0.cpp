...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    CData/*7:0*/ __Vdlyvdim0__sigdelay__DOT__sineRom__DOT__ram_array__v0;
...
void Vsigdelay___024root___eval_debug_assertions(Vsigdelay___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->writeEn & 0xfeU))) {
        Verilated::overWidthError("writeEn");}
    if (VL_UNLIKELY((vlSelf->readEn & 0xfeU))) {
        Verilated::overWidthError("readEn");}
}
#endif  // VL_DEBUG
